...
const RELEASE_NAME = 'Veo3 Auto v1.0.5 (Debug Screenshot)';
const ASSET_PATH = path.resolve('dist/Veo3 Auto Setup 1.0.5.exe');
const ASSET_NAME = 'Veo3 Auto Setup 1.0.5.exe';

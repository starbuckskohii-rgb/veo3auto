...
const RELEASE_NAME = 'Veo3 Auto v1.0.6 (UI Refine & Fixes)';
const ASSET_PATH = path.resolve('dist/Veo3 Auto Setup 1.0.6.exe');
const ASSET_NAME = 'Veo3 Auto Setup 1.0.6.exe';
